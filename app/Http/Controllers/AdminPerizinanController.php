...
class AdminPerizinanController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('admin.perizinan.dashboard', compact('totalPerizinan', 'disetujui', 'proses', 'ditolak', 'hariIni'));
    }
    ...
    public function dataIndex()
    {
        ...
        return view('admin.perizinan.data.index', compact('data'));
    }

    public function dataCreate()
    {
        $jenisIzin = PerizinanJenis::where('status', 'Aktif')->get();
        return view('admin.perizinan.data.form', compact('jenisIzin'));
    }
    ...
    public function dataStore(Request $request)
    {
        ...
        return redirect()->route('admin.perizinan.data.index')->with('success', 'Data perizinan berhasil ditambahkan.');
    }

    public function dataEdit(PerizinanData $data)
    {
        $jenisIzin = PerizinanJenis::where('status', 'Aktif')->get();
        return view('admin.perizinan.data.form', compact('data', 'jenisIzin'));
    }
    ...
    public function dataUpdate(Request $request, PerizinanData $data)
    {
        ...
        return redirect()->route('admin.perizinan.data.index')->with('success', 'Data perizinan berhasil diperbarui.');
    }

    public function dataDestroy(PerizinanData $data)
    {
        $data->delete();
        return redirect()->route('admin.perizinan.data.index')->with('success', 'Data perizinan berhasil dihapus.');
    }
    ...
    public function jenisIndex()
    {
        ...
        return view('admin.perizinan.jenis.index', compact('data'));
    }

    public function jenisCreate()
    {
        return view('admin.perizinan.jenis.form');
    }
    ...
    public function jenisStore(Request $request)
    {
        ...
        return redirect()->route('admin.perizinan.jenis.index')->with('success', 'Jenis izin berhasil ditambahkan.');
    }

    public function jenisEdit(PerizinanJenis $jenis)
    {
        return view('admin.perizinan.jenis.form', compact('jenis'));
    }
    ...
    public function jenisUpdate(Request $request, PerizinanJenis $jenis)
    {
        ...
        return redirect()->route('admin.perizinan.jenis.index')->with('success', 'Jenis izin berhasil diperbarui.');
    }
    ...
    public function jenisDestroy(PerizinanJenis $jenis)
    {
        try {
            ...
            $jenis->delete();
            return redirect()->route('admin.perizinan.jenis.index')->with('success', 'Jenis izin berhasil dihapus.');
        } catch (\Exception $e) {
            return redirect()->route('admin.perizinan.jenis.index')->with('error', 'Jenis izin tidak dapat dihapus karena masih digunakan.');
        }
    }
    ...
    public function publikasiIndex()
    {
        ...
        return view('admin.perizinan.publikasi.index', compact('data'));
    }

    public function publikasiCreate()
    {
        return view('admin.perizinan.publikasi.form');
    }
    ...
    public function publikasiStore(Request $request)
    {
        ...
        return redirect()->route('admin.perizinan.publikasi.index')->with('success', 'Publikasi berhasil ditambahkan.');
    }

    public function publikasiEdit(PerizinanPublikasi $publikasi)
    {
        return view('admin.perizinan.publikasi.form', compact('publikasi'));
    }
    ...
    public function publikasiUpdate(Request $request, PerizinanPublikasi $publikasi)
    {
        ...
        return redirect()->route('admin.perizinan.publikasi.index')->with('success', 'Publikasi berhasil diperbarui.');
    }
    ...
    public function publikasiDestroy(PerizinanPublikasi $publikasi)
    {
        ...
        $publikasi->delete();
        return redirect()->route('admin.perizinan.publikasi.index')->with('success', 'Publikasi berhasil dihapus.');
    }
    ...
    {
        $user = auth()->user();
        return view('admin.perizinan.profile', compact('user'));
    }
}
