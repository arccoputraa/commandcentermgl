...
<div class="detail-header">
    <div>
        ...
        <p>Detail data internal untuk data kartu keluarga.</p>
    </div>
    <a href="{{ route('kependudukan.data-kartu-keluarga.edit', $id) }}" class="edit-button">
...
<div class="detail-card">
    <div class="detail-grid">
        ...
        <div>
            <p class="detail-label">Rata</p>
            <p class="detail-value">{{ $item['rata_rata'] }}</p>
        </div>
        <div>
    ...
    <a href="{{ route('kependudukan.data-kartu-keluarga.index') }}" class="back-button">Kembali</a>
</div>
@endsection
