...
<div class="detail-header">
    <div>
        <h2>Detail Mutasi Penduduk</h2>
        <p>Detail data internal untuk mutasi penduduk.</p>
    </div>
    <a href="{{ route('kependudukan.mutasi-penduduk.edit', $id) }}" class="edit-button">
...
<div class="detail-card">
    <div class="detail-grid">
        ...
        <div>
            <p class="detail-label">Bulan</p>
            <p class="detail-value">{{ $item['bulan'] }}</p>
        </div>
        <div>
        ...
        <div>
            <p class="detail-label">Lahir</p>
            <p class="detail-value">{{ $item['kelahiran'] }}</p>
        </div>
        <div>
            <p class="detail-label">Mati</p>
            <p class="detail-value">{{ $item['kematian'] }}</p>
        </div>
        <div>
            <p class="detail-label">Datang</p>
            <p class="detail-value">{{ $item['pindah_datang'] }}</p>
        </div>
        <div>
            <p class="detail-label">Keluar</p>
            <p class="detail-value">{{ $item['pindah_keluar'] }}</p>
        </div>
        <div>
    ...
    <a href="{{ route('kependudukan.mutasi-penduduk.index') }}" class="back-button">Kembali</a>
</div>
@endsection
