...
<div class="page-header-custom">
    <a href="{{ route('profile.index') }}"><i class="fa-solid fa-angle-left"></i></a>
    <div>
...
<div class="edit-container">
    <form action="{{ route('profile.update') }}" method="POST">
        ...
        <p style="font-size: 14px; color: #64748b; margin-bottom: 24px;">Kosongkan password jika tidak ingin mengubahnya.</p>
