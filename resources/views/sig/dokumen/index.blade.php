...
<div class="page-header">
    <div class="page-title">
        <h1>Dokumen SIG</h1>
        <p>Manajemen file dokumen dan laporan peta (PDF).</p>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-btns">
                            ...
                            <form action="{{ route('sig.dokumen.destroy', $item->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Hapus dokumen ini?');">
                                @csrf @method('DELETE')
...
<div class="modal-backdrop" id="modalForm">
    <div class="modal-container" style="max-width: 500px;">
        ...
        <form id="formDokumen" method="POST" action="{{ route('sig.dokumen.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div style="margin-bottom: 16px;">
                ...
                <input type="text" name="status_tag" id="status_tag" required style="width:100%; padding:10px; border:1px solid #E2E8F0; border-radius:6px;" placeholder="Misal: Laporan Pemetaan">
            </div>
...
<script>
    function openModal(type, data = null) {
        ...
        if (type === 'edit') {
            ...
            form.action = `/admin/sig/dokumen/${data.id}`;
            ...
            form.action = `{{ route('sig.dokumen.store') }}`;
