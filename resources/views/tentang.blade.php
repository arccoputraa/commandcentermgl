  ...
  <section class="block scope-section">
    <div class="wrap">
      ...
      <div class="scope-grid">
        <a class="scope-card" href="layanan.html?dept=perizinan">
          <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 13h6M9 17h6M9 9h1"/></svg></div>
          <h3>Perizinan</h3>
          <p>Data layanan perizinan, pengajuan, persetujuan, dan status permohonan.</p>
        </a>
        <a class="scope-card" href="layanan.html?dept=kesehatan">
        ...
        <a class="scope-card" href="layanan.html?dept=keuangan">
        ...
        <a class="scope-card" href="layanan.html?dept=kepegawaian">
        ...
        <a class="scope-card" href="layanan.html?dept=kependudukan">
        ...
        <a class="scope-card" href="layanan.html?dept=pembangunan">
        ...
        <a class="scope-card" href="layanan.html?dept=perhubungan">
        ...
        <a class="scope-card" href="layanan.html?dept=sig">
    ...
    <div class="wrap">
      <div class="cta-banner">
        ...
        <div class="cta-actions">
          <a class="btn btn-white" href="index.html#layanan">
            Lihat Data Publik
